...
int main(int argc, char* argv[]) {
    ...
    // Alocação dinâmica para armazenar medidas
    ...
    while (fgets(line, sizeof(line), fp)) {
        ...
        Measure m;
        char sensor_name[64]; // ignorado

        // Formato esperado: sensorX %ld %s
    ...
    // Confirmação linear final (para garantir precisão máxima)
